...
class ProcessConfig:
    def __init__(self, csv_path=None, row_index=0, verbose=True):
        """
        ...
        if csv_path:
            self.center_lat, self.center_lon = self._load_coordinates_from_csv(csv_path, row_index)
        else:
        ...
        # Tower info - you might want to load this from CSV too
    ...
    def _load_coordinates_from_csv(self, csv_path, row_index):
